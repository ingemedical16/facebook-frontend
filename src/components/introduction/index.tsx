...
export default function Introduction({
  ...
  const updateUserDetails = async () => {
    try {
      ...
      setShowBio(false);
      setDetails(data.payload?.data?.details);
  ...
  return (
    <div className={styles.profileCard}>
      <div className={styles.profileCardHeader}>Introduction</div>

      {details?.biography && !showBio && (
        <div className={styles.infoCol}>
          <span className={styles.infoText}>{details.biography}</span>
          {!visitor && (
            <button
